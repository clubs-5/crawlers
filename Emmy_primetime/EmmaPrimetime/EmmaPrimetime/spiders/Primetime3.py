...
class PrimetimeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in response.css('#center-3-react > div > div > div:nth-child(2)'):
                for big_title in i.css('.event-widgets__award-category'):
                    ...
                    for article in big_title.css('.event-widgets__award-nomination'):
                        ...
                        url = article.css('.btn-full').css('::attr(href)').extract_first()
